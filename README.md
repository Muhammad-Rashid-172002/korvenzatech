...
## Leadership & client proof section
The production UI includes a responsive leadership and client-feedback section with optimized local image assets under `public/team/`. Replace the role-only labels for the co-founder and web engineer with verified public names whenever those names are ready to publish.
