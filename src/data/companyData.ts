...
export const SERVICES_DATA: ServiceItem[] = [
  ...
  },
  {
    ...
    businessValue: 'Improve reliability, protect customer data with encrypted backups, and design infrastructure that can scale with changing traffic demand.',
    ...
    useCases: [
      ...
      'Designing scalable platforms for high-traffic growth',
  ...
  },
  {
    ...
    useCases: [
      ...
      'Improving landing-page conversion through measurement and iterative testing',
...
export const CASE_STUDIES: CaseStudy[] = [
  {
    ...
    summary: 'An AI-assisted preparation platform covering speaking, writing, reading and listening practice with automated feedback and progress tracking.',
  ...
  },
  {
    ...
    tagline: 'End-to-End Service Marketplace Connecting Customers with Skilled Providers',
    summary: 'A multi-sided service marketplace designed around the full job journey — from customer requests and worker acceptance to location-aware progress, communication, completion and ratings.',
    ...
    solution: 'KorvenzaTech designed a role-based marketplace architecture for customers and workers with real-time requests, job status progression, location-aware workflows, communication, ratings and cloud-backed operational data.',
    ...
    features: [
      ...
      'Provider Profiles, Ratings & Job History'
    ],
    platform: 'Cross-Platform Marketplace Product',
    outcome: [
      'Separate customer and worker product experiences',
      'Request-to-completion job lifecycle with clear status progression',
      'Firebase-backed real-time marketplace workflows',
      'Google Maps integration for location-aware service flows'
    ],
    metrics: [
...
export const INDUSTRIES_DATA: IndustryItem[] = [
  {
    ...
    iconName: 'Activity',
    tagline: 'Privacy-conscious digital tools for healthcare workflows and sensitive data.',
    problemSolved: 'Reducing paper bottlenecks and fragmented workflows while designing around strong privacy, access-control and data-protection requirements.',
    exampleSolutions: ['Telemedicine Portals', 'Clinical Workflow Tools', 'Secure Patient Messaging', 'Medical Asset Tracking']
  },
  {
    id: 'education',
  ...
  },
  {
    ...
    problemSolved: 'Designing reliable financial workflows with strong attention to transaction integrity, access control, auditability and performance.',
...
A shared cross-platform codebase can reduce duplicated engineering effort while supporting both iOS and Android. Flutter is a strong option when a product needs consistent UI, fast iteration, native integrations, and maintainable feature delivery across platforms.`
  },
  {
...
export const FAQ_ITEMS: FAQItem[] = [
  ...
  },
  {
    ...
    answer: 'Yes. You can bring the idea or operational challenge in plain English, and we guide you through strategy, user experience design, and software engineering without unnecessary technical jargon.'
  },
  {
  ...
  },
  {
    ...
    answer: 'Yes. KorvenzaTech works remotely with clients and collaborators across different regions and supports international delivery with flexible communication schedules.'
  },
  {
  ...
  },
  {
    ...
    answer: 'Simply click "Start Your Project" or fill out our project inquiry form. Share a brief description of what you want to build, and our team will review it and respond with the most practical next step.'
  }
];
